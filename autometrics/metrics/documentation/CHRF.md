...
Where:
- $CHRP$ is the average precision of character and word n-grams: $CHRP = \frac{1}{N} \sum_{n=1}^N \frac{\text{n-grams in hypothesis and reference}}{\text{total n-grams in hypothesis}$
- $CHRR$ is the average recall of character and word n-grams: $CHRR = \frac{1}{N} \sum_{n=1}^N \frac{\text{n-grams in hypothesis and reference}}{\text{total n-grams in reference}}$
