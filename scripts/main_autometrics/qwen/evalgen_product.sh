...
sbatch --job-name="qwen_autometrics_${DATASET_NAME}_${TARGET_MEASURE}" \
       --output="logs/qwen_autometrics_${DATASET_NAME}_${TARGET_MEASURE}_%j.out" \
       --error="logs/qwen_autometrics_${DATASET_NAME}_${TARGET_MEASURE}_%j.err" \
