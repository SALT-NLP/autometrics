...
echo "  - HelpSteer group: HelpSteer, HelpSteer2 (10 dataset-measure combinations)"
...
if [ -f .temp_job_ids ]; then
    ...
    echo "    - HelpSteer: ~48h (10 combinations × 8 generators × 5 seeds)"
    ...
    echo "    - CoGym: ~48h (9 combinations × 8 generators × 5 seeds)"
    echo "    - Remaining: ~48h (8 combinations × 8 generators × 5 seeds)"
    echo "  - TOTAL: ~360h compute-hours across parallel jobs for both models"
    echo ""
    ...
    echo "  GPT-4o-mini: /nlp/scr3/nlp/20questions/dspy_cache/autometrics_metric_gen_gpt4o"
    echo "  Qwen3-32B: /nlp/scr3/nlp/20questions/dspy_cache/autometrics_metric_gen_qwen"
    echo ""
